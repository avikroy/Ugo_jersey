...
#define kAlertViewTitleTextColor   [UIColor colorWithRed:255.0/255.0 green:102.0/255.0 blue:1.0/255.0  alpha:1.0]
...
#define kAlertViewMessageTextColor    [UIColor whiteColor]
...
#define kAlertViewButtonShadowColor     [UIColor redColor]
